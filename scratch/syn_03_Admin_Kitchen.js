...
function getKitchenSummary(date) {
  ...
  dayRows.forEach(function(r) {
    ...
    orders.push({
      ...
      Customer_Name: (r._lsTab && !String(r.Customer_Name || "").trim().startsWith("[LS]")) ? "[LS] " + String(r.Customer_Name || "") : String(r.Customer_Name || ""),
      Meal_Type: meal,
...
function getDriverOrders(date) {
  ...
  rows.forEach(function(r) {
    ...
    meals[meal].push({
      submissionId:  sid,
      name:          (String(r.Source || "").trim() === "LS" && !String(r.Customer_Name || "").trim().startsWith("[LS]")) ? "[LS] " + String(r.Customer_Name || "") : String(r.Customer_Name || ""),
