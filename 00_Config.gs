...
const TAB_DEFAULT_CAPS    = "SK_Default_Caps";    // single row: Breakfast/Lunch/Dinner default delivery caps (admin-editable; per-date Order_Cap_JSON overrides still win)
...
const DEFAULT_ORDER_CAPS = { Breakfast: 11, Lunch: 24, Dinner: 23 };
