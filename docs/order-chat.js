  ...
  function init() {
    ...
    var CHIPS = IS_LS ? [
      ...
      { label: "💰 How pricing works", msg: "How does your pricing work — how do I build a meal and what does it cost?",
        answer: "You build your own meal — no fixed thali, pick exactly what you want (Lunch & Dinner):\n\n**Breads:** Chapati ₹10 (~7\") · Without-oil Chapati ₹9 (~7\") · Phulka ₹8 (5–5.5\") · Ghee Phulka ₹11 (5–5.5\") · Jowar/Bajra Bhakri ₹22\n**Sabji:** Mini [100ml] ₹24 · Full [250ml] ₹48 (dry or curry)\n**Basics:** Dal [200ml] ₹24 · Dal Fry [200ml] ₹40 · Rice [100g] ₹13 · Salad [40g] ₹8 · Curd [50g] ₹13\n\n💡 **Portion Note:** Sabji 100ml and 250ml indicate container liquid volume capacity (water volume equivalent); weight in grams varies by dish density.\n🥗 **Food Clarity:** Tap the **ℹ️ chip** next to any item on the order screen to see approximate Calories, Protein, Carbs, Fats, Fiber, ingredients, and chef notes!\n\nA typical meal — 2 Chapati + Full Sabji + Dal + Rice — is about ₹105 before discounts. 💛" },
